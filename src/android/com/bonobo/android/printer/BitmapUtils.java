...
public class BitmapUtils {
  ...
  public Bitmap decodeBitmapByStream(InputStream is, Rect bounds, int width, int height) {
    ...
    try {
      ...
      bitmap = BitmapFactory.decodeStream(is, null, options);//!!!!æº¢å‡º
    } catch (Exception e) {
  ...
  public static Bitmap rotateBitmap(Bitmap bitmap, float degrees) {
    if (degrees != 0 && bitmap != null) {
      ...
      try {
        ...
        //                 if (bitmap != b2) {
        //                	 bitmap.recycle();  //Androidå¼€å�‘ç½‘å†�æ¬¡æ��ç¤ºBitmapæ“�ä½œå®Œåº”è¯¥æ˜¾ç¤ºçš„é‡Šæ”¾
        //                	 bitmap = b2;
        //                 }
      } catch (OutOfMemoryError ex) {
        // Androidå»ºè®®å¤§å®¶å¦‚æžœå‡ºçŽ°äº†å†…å­˜ä¸�è¶³å¼‚å¸¸ï¼Œæœ€å¥½return åŽŸå§‹çš„bitmapå¯¹è±¡ã€‚.
      }
    }
    return bitmap;
  }
